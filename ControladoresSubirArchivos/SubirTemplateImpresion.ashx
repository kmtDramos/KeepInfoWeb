<%@ WebHandler Language="C#" Class="SubirTemplateImpresion" %>
using System;
...
public class SubirTemplateImpresion : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        string ruta = HttpContext.Current.Server.MapPath("~") + "\\Archivos\\TemplatesImpresion";
