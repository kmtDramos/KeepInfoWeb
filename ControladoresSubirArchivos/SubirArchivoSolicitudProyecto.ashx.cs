...
namespace arquitecturaNet.ControladoresSubirArchivos
{
    ...
    public class SubirArchivoSolicitudProyecto : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            int IdOportunidad = Convert.ToInt32(HttpContext.Current.Request["pIdSolicitudProyecto"]);
            ...
            filename = "archivo_solicitudProyecto_" + IdOportunidad + "." + aFileName.GetValue(aFileName.Length - 1);
