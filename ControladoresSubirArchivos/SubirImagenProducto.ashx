<%@ WebHandler Language="C#" Class="SubirImagenProducto" %>
using System;
...
public class SubirImagenProducto : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        string ruta = HttpContext.Current.Server.MapPath("~") + "\\Archivos\\ImagenProducto";
