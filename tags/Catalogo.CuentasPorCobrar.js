        ...
        despuesDeCompilar: function(pRespuesta) {
            ...
            $("#txtFechaAplicacion").datepicker({
                onSelect: function() {
                    ...
                    pRequest.pIdTipoMonedaDestino = $("#cmbTipoMoneda").val();
...
function AgregarCuentasPorCobrar() {
    ...
    pCuentasPorCobrar.Importe = $("#txtImporte").val();
    ...
    pCuentasPorCobrar.TipoCambio = QuitarFormatoNumero($("#spanTipoCambio").text());
