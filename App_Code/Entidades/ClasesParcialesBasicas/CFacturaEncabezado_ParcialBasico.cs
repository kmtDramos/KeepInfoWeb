...
public partial class CFacturaEncabezado
{
	...
	public int IdFacturaAnticipo
	{
		get { return idFacturaAnticipo; }
		set
		{
			idFacturaAnticipo = value;
		}
	}
	...
	public void LlenaObjeto(int pIdentificador, CConexion pConexion)
	{
		...
		foreach (CFacturaEncabezado O in Obten.ListaRegistros)
		{
			...
			anticipo = O.Anticipo;
			idFacturaAnticipo = O.IdFacturaAnticipo;
	...
	public void Editar(CConexion pConexion)
	{
		...
		Editar.StoredProcedure.Parameters.AddWithValue("@pAnticipo", anticipo);
		Editar.StoredProcedure.Parameters.AddWithValue("@pIdFacturaAnticipo", idFacturaAnticipo);
