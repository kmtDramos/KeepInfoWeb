...
public partial class CExistenciaHistorico
{
	//Propiedades Privadas
	private int idExistenciaHistorico;
	...
	//Propiedades
	public int IdExistenciaHistorico
	{
		get { return idExistenciaHistorico; }
		set
		{
			idExistenciaHistorico = value;
		}
	}
	...
	//Constructores
	public CExistenciaHistorico()
	{
		idExistenciaHistorico = 0;
		idProducto = 0;
	...
	public CExistenciaHistorico(int pIdExistenciaHistorico)
	{
		idExistenciaHistorico = pIdExistenciaHistorico;
		idProducto = 0;
		fecha = new DateTime(1, 1, 1);
		cantidadInicial = 0;
		cantidadFinal = 0;
	...
	public List<object> LlenaObjetos(CConexion pConexion)
	{
		...
		Obten.StoredProcedure.CommandText = "spb_ExistenciaHistorico_Consultar";
		Obten.StoredProcedure.Parameters.AddWithValue("@Opcion", 1);
		Obten.Llena<CExistenciaHistorico>(typeof(CExistenciaHistorico), pConexion);
	...
	public void LlenaObjeto(int pIdentificador, CConexion pConexion)
	{
		...
		Obten.StoredProcedure.Parameters.AddWithValue("@pIdExistenciaHistorico", pIdentificador);
		Obten.Llena<CExistenciaHistorico>(typeof(CExistenciaHistorico), pConexion);
		foreach (CExistenciaHistorico O in Obten.ListaRegistros)
		{
			idExistenciaHistorico = O.IdExistenciaHistorico;
	...
	{
		CSelect Obten = new CSelect();
		Obten.StoredProcedure.CommandText = "spb_ExistenciaHistorico_ConsultarFiltros";
	...
	public void Agregar(CConexion pConexion)
	{
		...
		Agregar.StoredProcedure.CommandText = "spb_ExistenciaHistorico_Agregar";
		Agregar.StoredProcedure.Parameters.AddWithValue("@Opcion", 1);
		Agregar.StoredProcedure.Parameters.AddWithValue("@pIdExistenciaHistorico", 0);
		Agregar.StoredProcedure.Parameters["@pIdExistenciaHistorico"].Direction = ParameterDirection.Output;
		...
		Agregar.StoredProcedure.Parameters.AddWithValue("@pIdExistenciaReal", idExistenciaReal);
		Agregar.Insert(pConexion);
		idExistenciaHistorico= Convert.ToInt32(Agregar.StoredProcedure.Parameters["@pIdExistenciaHistorico"].Value);
	}
	
	public void Editar(CConexion pConexion)
	{
		CConsultaAccion Editar = new CConsultaAccion();
		Editar.StoredProcedure.CommandText = "spb_ExistenciaHistorico_Editar";
		Editar.StoredProcedure.Parameters.AddWithValue("@Opcion", 1);
		Editar.StoredProcedure.Parameters.AddWithValue("@pIdExistenciaHistorico", idExistenciaHistorico);
	...
	public void Eliminar(CConexion pConexion)
	{
		...
		Eliminar.StoredProcedure.CommandText = "spb_ExistenciaHistorico_Eliminar";
		Eliminar.StoredProcedure.Parameters.AddWithValue("@Opcion", 1);
		Eliminar.StoredProcedure.Parameters.AddWithValue("@pIdExistenciaHistorico", idExistenciaHistorico);
