...
public partial class CEstatusLevantamiento
{
	...
	public List<object> LlenaObjetos(CConexion pConexion)
	{
		...
		Obten.StoredProcedure.CommandText = "spb_EstatusLevantamiento_Consultar";
		Obten.StoredProcedure.Parameters.AddWithValue("@Opcion", 1);
		Obten.StoredProcedure.Parameters.AddWithValue("@pBaja", 0);
		Obten.Llena<CEstatusLevantamiento>(typeof(CEstatusLevantamiento), pConexion);
	...
	public void LlenaObjeto(int pIdentificador, CConexion pConexion)
	{
		...
		Obten.StoredProcedure.Parameters.AddWithValue("@pIdEstatusLevantamiento", pIdentificador);
		Obten.StoredProcedure.Parameters.AddWithValue("@pBaja", 0);
		Obten.Llena<CEstatusLevantamiento>(typeof(CEstatusLevantamiento), pConexion);
	...
	{
		CSelect Obten = new CSelect();
		Obten.StoredProcedure.CommandText = "spb_EstatusLevantamiento_ConsultarFiltros";
	...
	public void Agregar(CConexion pConexion)
	{
		...
		Agregar.StoredProcedure.CommandText = "spb_EstatusLevantamiento_Agregar";
	...
	public void Eliminar(CConexion pConexion)
	{
		...
		Eliminar.StoredProcedure.CommandText = "spb_EstatusLevantamiento_Eliminar";
		Eliminar.StoredProcedure.Parameters.AddWithValue("@Opcion", 2);
		Eliminar.StoredProcedure.Parameters.AddWithValue("@pIdEstatusLevantamiento", idEstatusLevantamiento);
