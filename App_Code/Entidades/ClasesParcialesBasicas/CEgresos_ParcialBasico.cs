...
public partial class CEgresos
{
	...
	public CEgresos(int pIdEgresos)
	{
		idEgresos = pIdEgresos;
		fechaMovimiento = new DateTime(1, 1, 1);
		idTipoDcocumento = 0;
		idCuentaBancaria = 0;
		importe = 0;
	...
	public List<object> LlenaObjetos(CConexion pConexion)
	{
		...
		Obten.StoredProcedure.CommandText = "spb_Egresos_Consultar";
		Obten.StoredProcedure.Parameters.AddWithValue("@Opcion", 1);
		Obten.StoredProcedure.Parameters.AddWithValue("@pBaja", 0);
		Obten.Llena<CEgresos>(typeof(CEgresos), pConexion);
	...
	public void LlenaObjeto(int pIdentificador, CConexion pConexion)
	{
		...
		Obten.StoredProcedure.Parameters.AddWithValue("@pIdEgresos", pIdentificador);
		Obten.StoredProcedure.Parameters.AddWithValue("@pBaja", 0);
		Obten.Llena<CEgresos>(typeof(CEgresos), pConexion);
		foreach (CEgresos O in Obten.ListaRegistros)
		{
	...
	{
		CSelect Obten = new CSelect();
		Obten.StoredProcedure.CommandText = "spb_Egresos_ConsultarFiltros";
	...
	public void Agregar(CConexion pConexion)
	{
		...
		Agregar.StoredProcedure.CommandText = "spb_Egresos_Agregar";
	...
	public void Editar(CConexion pConexion)
	{
		...
		Editar.StoredProcedure.CommandText = "spb_Egresos_Editar";
	...
	public void Eliminar(CConexion pConexion)
	{
		...
		Eliminar.StoredProcedure.CommandText = "spb_Egresos_Eliminar";
		Eliminar.StoredProcedure.Parameters.AddWithValue("@Opcion", 2);
		Eliminar.StoredProcedure.Parameters.AddWithValue("@pIdEgresos", idEgresos);
