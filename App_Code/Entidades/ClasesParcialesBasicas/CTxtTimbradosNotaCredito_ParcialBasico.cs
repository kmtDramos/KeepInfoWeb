...
public partial class CTxtTimbradosNotaCredito
{
	//Propiedades Privadas
	private int idTxtTimbradosNotaCredito;
	...
	//Propiedades
	public int IdTxtTimbradosNotaCredito
	{
		get { return idTxtTimbradosNotaCredito; }
		set
		{
			if (value < 0)
			{
			...
			idTxtTimbradosNotaCredito = value;
		}
	}
	...
	//Constructores
	public CTxtTimbradosNotaCredito()
	{
		idTxtTimbradosNotaCredito = 0;
		noCertificadoSAT = "";
		fechaTimbrado = "";
		uuid = "";
		noCertificado = "";
	...
	public CTxtTimbradosNotaCredito(int pIdTxtTimbradosNotaCredito)
	{
		idTxtTimbradosNotaCredito = pIdTxtTimbradosNotaCredito;
		noCertificadoSAT = "";
		fechaTimbrado = "";
		uuid = "";
		noCertificado = "";
	...
	public List<object> LlenaObjetos(CConexion pConexion)
	{
		...
		Obten.StoredProcedure.CommandText = "spb_TxtTimbradosNotaCredito_Consultar";
	...
	public void LlenaObjeto(int pIdentificador, CConexion pConexion)
	{
		...
		Obten.StoredProcedure.Parameters.AddWithValue("@pIdTxtTimbradosNotaCredito", pIdentificador);
		Obten.Llena<CTxtTimbradosNotaCredito>(typeof(CTxtTimbradosNotaCredito), pConexion);
	...
	public void Agregar(CConexion pConexion)
	{
		...
		Agregar.StoredProcedure.CommandText = "spb_TxtTimbradosNotaCredito_Agregar";
		Agregar.StoredProcedure.Parameters.AddWithValue("@Opcion", 1);
		Agregar.StoredProcedure.Parameters.AddWithValue("@pIdTxtTimbradosNotaCredito", 0);
		Agregar.StoredProcedure.Parameters["@pIdTxtTimbradosNotaCredito"].Direction = ParameterDirection.Output;
		...
		idTxtTimbradosNotaCredito= Convert.ToInt32(Agregar.StoredProcedure.Parameters["@pIdTxtTimbradosNotaCredito"].Value);
	}
	
	public void Editar(CConexion pConexion)
	{
		CConsultaAccion Editar = new CConsultaAccion();
		Editar.StoredProcedure.CommandText = "spb_TxtTimbradosNotaCredito_Editar";
		Editar.StoredProcedure.Parameters.AddWithValue("@Opcion", 1);
		Editar.StoredProcedure.Parameters.AddWithValue("@pIdTxtTimbradosNotaCredito", idTxtTimbradosNotaCredito);
	...
	public void Eliminar(CConexion pConexion)
	{
		...
		Eliminar.StoredProcedure.CommandText = "spb_TxtTimbradosNotaCredito_Eliminar";
		Eliminar.StoredProcedure.Parameters.AddWithValue("@Opcion", 1);
		Eliminar.StoredProcedure.Parameters.AddWithValue("@pIdTxtTimbradosNotaCredito", idTxtTimbradosNotaCredito);
