<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPageSeguridad.Master" AutoEventWireup="true" CodeFile="ReporteInventarioActualSucursalProducto.aspx.cs" Inherits="ReporteInventarioActualSucursalProducto" Title ="Reporte de inventario" %>
<asp:Content ID="headReportesEstadoCuentaClientes" ContentPlaceHolderID="headMasterPageSeguridad" runat="server">
    ...
    <script type="text/javascript"  src="../js/Reportes.ReportesInventarioActualSucursalProducto.js"></script>
...
<asp:Content ID="bodyCatalogoReportesKeep" ContentPlaceHolderID="bodyMasterPageSeguridad" runat="server">
   <!--Dialogs-->
    <div id="divContenido">
        <div id="divFiltrosReporteInventarioActualSucursalProducto" idSucursal="0"></div> 
        <br/>  
        <div id="divInventarioActualSucursalProducto" idSucursal="0"></div>
    </div>     
