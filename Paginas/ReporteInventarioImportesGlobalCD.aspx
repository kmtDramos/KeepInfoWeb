<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPageSeguridad.Master" AutoEventWireup="true" CodeFile="ReporteInventarioImportesGlobalCD.aspx.cs" Inherits="ReporteInventarioImportesGlobalCD" Title="Página sin título" %>
<asp:Content ID="headReporte" ContentPlaceHolderID="headMasterPageSeguridad" runat="server">
    ...
    <script type="text/javascript"  src="../js/Reportes.ReportesInventarioImportesGlobalCD.js"></script>
</asp:Content>
