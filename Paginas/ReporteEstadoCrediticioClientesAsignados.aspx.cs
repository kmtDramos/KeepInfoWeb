...
public partial class ReporteEstadoCrediticioClientesAsignados : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ColFechaPagoFacturacionConsultar.Encabezado = "Fecha pago";
    ...
    [WebMethod]
    public static string ObtieneEstadoCrediticioCliente(int pIdFiltroClientesAsignados)
    {
        CConexion ConexionBaseDatos = new CConexion();
        string respuesta = ConexionBaseDatos.ConectarBaseDatosSqlServer();
        JObject oRespuesta = new JObject();
    ...
    [WebMethod]
    public static string ObtieneRelacionSaldos(int pIdSucursal, string pSucursal, int pIdFiltroClientesAsignados)
    {
        CConexion ConexionBaseDatos = new CConexion();
        string respuesta = ConexionBaseDatos.ConectarBaseDatosSqlServer();
        JObject oRespuesta = new JObject();
        ...
        if (respuesta == "Conexion Establecida")
        {
            ...
            DateTime Fecha = DateTime.Now;
            CSelectEspecifico ConsultaReporteEstadoCrediticioCliente = new CSelectEspecifico();
            ConsultaReporteEstadoCrediticioCliente.StoredProcedure.CommandText = "SP_Impresion_EstadoCrediticioClienteRelacionSaldosAsignados";
            //ConsultaReporteEstadoCrediticioCliente.StoredProcedure.Parameters.AddWithValue("@pFechaInicial", pFechaInicial);
            ConsultaReporteEstadoCrediticioCliente.StoredProcedure.Parameters.AddWithValue("@pIdSucursal", pIdSucursal);
            ConsultaReporteEstadoCrediticioCliente.StoredProcedure.Parameters.AddWithValue("@pIdUsuario", Convert.ToInt32(HttpContext.Current.Session["IdUsuario"]));
            ConsultaReporteEstadoCrediticioCliente.StoredProcedure.Parameters.AddWithValue("@pIdFiltroClientesAsignados", Convert.ToInt32(pIdFiltroClientesAsignados));
            ConsultaReporteEstadoCrediticioCliente.Llena(ConexionBaseDatos);
    ...
    [WebMethod]
    public static string ObtieneRelacionSaldosPesosGeneral(int pIdSucursal, string pSucursal, int pIdFiltroClientesAsignados)
    {
        CConexion ConexionBaseDatos = new CConexion();
        string respuesta = ConexionBaseDatos.ConectarBaseDatosSqlServer();
        JObject oRespuesta = new JObject();
        ...
        if (respuesta == "Conexion Establecida")
        {
            ...
            DateTime Fecha = DateTime.Now;
            CSelectEspecifico ConsultaReporteEstadoCrediticioCliente = new CSelectEspecifico();
            ConsultaReporteEstadoCrediticioCliente.StoredProcedure.CommandText = "SP_Impresion_EstadoCrediticioClienteRelacionSaldosPesosGeneralAsignados";
            //ConsultaReporteEstadoCrediticioCliente.StoredProcedure.Parameters.AddWithValue("@pFechaInicial", pFechaInicial);
            ConsultaReporteEstadoCrediticioCliente.StoredProcedure.Parameters.AddWithValue("@pIdSucursal", pIdSucursal);
            ConsultaReporteEstadoCrediticioCliente.StoredProcedure.Parameters.AddWithValue("@pIdUsuario", Convert.ToInt32(HttpContext.Current.Session["IdUsuario"]));
            ConsultaReporteEstadoCrediticioCliente.StoredProcedure.Parameters.AddWithValue("@pIdFiltroClientesAsignados", Convert.ToInt32(pIdFiltroClientesAsignados));
    ...
    [WebMethod]
    public static string ObtieneRelacionSaldosPesosGeneralTCD(int pIdSucursal, string pSucursal, int pIdFiltroClientesAsignados)
    {
        CConexion ConexionBaseDatos = new CConexion();
        string respuesta = ConexionBaseDatos.ConectarBaseDatosSqlServer();
        JObject oRespuesta = new JObject();
        ...
        if (respuesta == "Conexion Establecida")
        {
            ...
            DateTime Fecha = DateTime.Now;
            CSelectEspecifico ConsultaReporteEstadoCrediticioCliente = new CSelectEspecifico();
            ConsultaReporteEstadoCrediticioCliente.StoredProcedure.CommandText = "SP_Impresion_EstadoCrediticioClienteRelacionSaldosPesosGeneralTCDAsignados";
            ConsultaReporteEstadoCrediticioCliente.StoredProcedure.Parameters.AddWithValue("@pIdSucursal", pIdSucursal);
            ConsultaReporteEstadoCrediticioCliente.StoredProcedure.Parameters.AddWithValue("@pIdUsuario", Convert.ToInt32(HttpContext.Current.Session["IdUsuario"]));
            ConsultaReporteEstadoCrediticioCliente.StoredProcedure.Parameters.AddWithValue("@pIdFiltroClientesAsignados", Convert.ToInt32(pIdFiltroClientesAsignados));
            ConsultaReporteEstadoCrediticioCliente.Llena(ConexionBaseDatos);
    ...
    [WebMethod]
    public static string ObtieneRelacionSaldosDolares(int pIdSucursal, string pSucursal, int pIdFiltroClientesAsignados)
    {
        CConexion ConexionBaseDatos = new CConexion();
        string respuesta = ConexionBaseDatos.ConectarBaseDatosSqlServer();
        JObject oRespuesta = new JObject();
        ...
        if (respuesta == "Conexion Establecida")
        {
            ...
            DateTime Fecha = DateTime.Now;
            CSelectEspecifico ConsultaReporteEstadoCrediticioCliente = new CSelectEspecifico();
            ConsultaReporteEstadoCrediticioCliente.StoredProcedure.CommandText = "SP_Impresion_EstadoCrediticioClienteRelacionSaldosDolaresAsignados";
            //ConsultaReporteEstadoCrediticioCliente.StoredProcedure.Parameters.AddWithValue("@pFechaInicial", pFechaInicial);
            ConsultaReporteEstadoCrediticioCliente.StoredProcedure.Parameters.AddWithValue("@pIdSucursal", pIdSucursal);
            ConsultaReporteEstadoCrediticioCliente.StoredProcedure.Parameters.AddWithValue("@pIdUsuario", Convert.ToInt32(HttpContext.Current.Session["IdUsuario"]));
            ConsultaReporteEstadoCrediticioCliente.StoredProcedure.Parameters.AddWithValue("@pIdFiltroClientesAsignados", Convert.ToInt32(pIdFiltroClientesAsignados));
