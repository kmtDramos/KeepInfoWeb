<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPageSeguridad.Master" AutoEventWireup="true" CodeFile="ReporteEstadoCuentaProveedores.aspx.cs" Inherits="ReporteEstadoCuentaProveedores" Title ="Reporte estado cuenta proveedores" %>
<asp:Content ID="headReportesEstadoCuentaProveedores" ContentPlaceHolderID="headMasterPageSeguridad" runat="server">
    ...
    <script type="text/javascript"  src="../js/Reportes.ReportesEstadoDeCuentaProveedores.js"></script>
...
<asp:Content ID="bodyCatalogoReportesKeep" ContentPlaceHolderID="bodyMasterPageSeguridad" runat="server">
   <!--Dialogs-->
    ...
    <div id="divContenido">
        <div id="divFiltrosReporteEstadoCuentaProveedores" idProveedor="0"></div>
        <br />
