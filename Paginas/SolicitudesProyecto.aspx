<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPageSeguridad.Master" AutoEventWireup="true" CodeFile="SolicitudesProyecto.aspx.cs" Inherits="Paginas_SolicitudesProyecto" Title="Solicitudes Proyecto" %>
<asp:Content ID="headCatalogoTiempoEntrega" ContentPlaceHolderID="headMasterPageSeguridad" runat="server">
	...
	<script type="text/javascript" src="../js/SolicitudesProyecto.js?_=<%= DateTime.Now.Ticks %>"></script>
</asp:Content>
