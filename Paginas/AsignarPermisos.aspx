<%@ Page Language="C#" MasterPageFile="../MasterPages/MasterPageSeguridad.Master" AutoEventWireup="true" CodeFile="AsignarPermisos.aspx.cs" Inherits="AsignarPermisos" Title="Seguridad" %>
<asp:Content ID="headSeguridadPaginas" ContentPlaceHolderID="headMasterPageSeguridad" runat="server">
    ...
    <!--DHX-->
    <script type="text/javascript"  src="../js/Seguridad.AsignarPermisos.js"></script>
</asp:Content>
