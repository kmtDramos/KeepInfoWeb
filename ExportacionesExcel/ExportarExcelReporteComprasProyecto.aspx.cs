...
public partial class ExportacionesExcel_ExportarExcelReporteComprasProyecto : System.Web.UI.Page
{
    ...
    private void ExportarReporte(string Inicio, string Fin)
    {
        ...
        SqlCommand Stored = new SqlCommand("sp_Exportar_OrdenCompraProyecto", sqlCon);
        ...
        Response.AddHeader("content-disposition", "attachment; filename=ReporteOrdenesCompraProyecto.xls");
