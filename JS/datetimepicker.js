        ...
        $.extend(Timepicker.prototype, {
            ...
            var d = extendRemove(extendRemove({}, $.timepicker._defaults), c || {}),
                f = (-1 !== a.replace(/\'.*?\'/g, "").indexOf("Z"), function(a, b, c) {
                    ...
                    return i ? (-1 !== g.t && (void 0 === i[g.t] || 0 === i[g.t].length ? (h = "", j.ampm = "") : (h = -1 !== $.inArray(i[g.t].toUpperCase(), $.map(c.amNames, function(a, b) {
                        return a.toUpperCase()
                    })) ? "AM" : "PM", j.ampm = c["AM" === h ? "amNames" : "pmNames"][0])), -1 !== g.h && ("AM" === h && "12" === i[g.h] ? j.hour = 0 : "PM" === h && "12" !== i[g.h] ? j.hour = parseInt(i[g.h], 10) + 12 : j.hour = Number(i[g.h])), -1 !== g.m && (j.minute = Number(i[g.m])), -1 !== g.s && (j.second = Number(i[g.s])), -1 !== g.l && (j.millisec = Number(i[g.l])), -1 !== g.c && (j.microsec = Number(i[g.c])), -1 !== g.z && void 0 !== i[g.z] && (j.timezone = $.timepicker.timezoneOffsetNumber(i[g.z])), j) : !1
                }),
                g = function(a, b, c) {
                    try {
