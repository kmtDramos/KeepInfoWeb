...
function ImprimirInventarioImportesGlobal() {
    ...
    $.ajax({
        type: "POST",
        url: "ReporteInventarioImportesGlobal.aspx/ImprimirInventarioImportesGlobal",
...
function ObtenerFormaFiltroReporteInventarioImportesGlobal() {
    $("#divFiltrosReporteInventarioImportesGlobal").obtenerVista({
        ...
        url: "ReporteInventarioImportesGlobal.aspx/ObtenerFormaFiltroReporteInventarioImportesGlobal",
...
function ObtieneInventarioImportesGlobal(pRequest) {
    ...
    nombreTemplate: "tmplReporteInventarioImportesGlobal.html",                   
        parametros: pRequest,
        url: "ReporteInventarioImportesGlobal.aspx/ObtieneInventarioImportesGlobal",
        despuesDeCompilar: function(pRespuesta) {
